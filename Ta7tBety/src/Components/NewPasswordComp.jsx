        ...
        <>
             <div className="signinBody ">
                ...
                <div className="signinBage ">
                    ...
                    <p className="NewPassParagraph">Your New Password must be Different from previous used Password</p>

                    <div className="SigninForm NewPassForm">
                    <form action="">
                        <div className="SigninEmail Password">
                        <label className="EmailLabelonframe" htmlFor="">Password</label>
                        <input type="text" />
                    ...
                    <button className="SignInbtn NewPassbtn">Create New Password</button>
                    </form>
                    </div>
                    </div>
                    </div>
