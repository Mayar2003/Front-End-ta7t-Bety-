    ...
    return(
        ...
        <div className="MyOrdersLeftDiv ">
          <div className="MyOrdersChoices">
            <Link to="MyActiveOrders" className="decorationNone"> <p>Active</p> </Link>
            <Link to="MyCanceldOrders" className="decorationNone"> <p>Canceled</p></Link>
            <Link to="MyCompletedOrders" className="decorationNone"> <p>Completed</p></Link>
